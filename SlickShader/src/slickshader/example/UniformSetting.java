...
public class UniformSetting extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		uniformTester = Shader.makeShader("data/basicVertexShader.vrt", "data/settingUniformArray.frg");
		uniformTester.startShader();
		uniformTester
				.setUniformFloatVariable("myUniformArray",
						new float[] { 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f })
				.setUniformFloatVariable("myUniformFloat", 0.5f)
				.setUniformFloatVariable("myUniformVector2f", 1.0f, 0.0f).setUniformIntVariable("myUniformInt", 2);
