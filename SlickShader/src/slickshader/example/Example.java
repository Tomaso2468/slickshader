...
import slickshader.MultiTex;
import slickshader.Shader;

/**
 * Simple example/test class for shader support stuff.
 * 
 * @author Chronocide (Jeremy Klix) [Modifications made by Tomas2468]
 */
public class Example extends BasicGame {
	...
	public void init(GameContainer gc) throws SlickException {
		mandelbrot = Shader.makeShader(Shader.class.getResource("/fractal.vrt"),
				Shader.class.getResource("/mandelbrot.frg"));
		julia = Shader.makeShader(Shader.class.getResource("/fractal.vrt"), Shader.class.getResource("/julia.frg"));
		wave = Shader.makeShader(Shader.class.getResource("/wave.vrt"), Shader.class.getResource("/wave.frg"));
...
//                               "data/glLight_VertShader.frg");
		...
		quad1 = new float[] { 0, 0, 0, 0, 2, 0, 3, 2, 0, 3, 0, 0 };
		quad2 = new float[] { 0, 0, 0, 0, 1, 0, 1, 1, 0, 1, 0, 0 };
		...
		GL11.glLight(GL11.GL_LIGHT0, GL11.GL_POSITION, fbpos);
